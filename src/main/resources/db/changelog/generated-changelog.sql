...
-- changeset dimka:1709829390634-1
...
-- changeset dimka:1709829390634-2
...
-- changeset dimka:1709829390634-3
...
-- changeset dimka:1709829390634-4
...
-- changeset dimka:1709829390634-5
...
-- changeset dimka:1709829390634-6
...
-- changeset dimka:1709829390634-7
...
-- changeset dimka:1709829390634-8
...
-- changeset dimka:1709829390634-9
...
-- changeset dimka:1709829390634-10
...
-- changeset dimka:1709829390634-11
...
-- changeset dimka:1709829390634-12
...
-- changeset dimka:1709829390634-13
...
-- changeset dimka:1709829390634-14
...
-- changeset dimka:1709829390634-15
...
-- changeset dimka:1709829390634-16
...
-- changeset dimka:1709829390634-17
CREATE TABLE public.tokens (id INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, expired BOOLEAN NOT NULL, revoked BOOLEAN NOT NULL, token VARCHAR(255), token_type VARCHAR(255), user_id BIGINT, CONSTRAINT "tokensPK" PRIMARY KEY (id));

-- changeset dimka:1709829390634-18
CREATE TABLE public.user_tasks (readiness BOOLEAN, user_id BIGINT NOT NULL, task_id BIGINT NOT NULL);

-- changeset dimka:1709829390634-19
...
-- changeset dimka:1709829390634-24
...
-- changeset dimka:1709829390634-25
...
-- changeset dimka:1709829390634-26
...
-- changeset dimka:1709829390634-27
...
-- changeset dimka:1709829390634-28
...
-- changeset dimka:1709829390634-36
...
-- changeset dimka:1709829390634-37
...
-- changeset dimka:1709829390634-38
...
-- changeset dimka:1709829390634-39
